import { PlayerColor, SetColorStateType, BoardState, SetBoardStateType, GenericStringSetStateType, MoveHistoryType, SetMoveHistoryType, CapturedPiecesType, SetCapturedPieceType, KingSquareType, SetKingSquareType, SetKingInCheckType, SetCheckMateType, SetStaleMateType, SetValidMovesType, OccupiedSquaresType, SetOccupiedScaresType, SetFiftyMovesTrackerType, SquareInfoType } from "../types";
...
export const executeValidMove = (srcSquareId: string, targetSquareId: string, pieceId: string, colorState: PlayerColor, setColorState: SetColorStateType, currentBoard: BoardState, setBoardState: SetBoardStateType, setAlertMessage: GenericStringSetStateType, movesHistory: MoveHistoryType[], setMoveHistory: SetMoveHistoryType, capturedPieces: CapturedPiecesType, setCapturedPiece: SetCapturedPieceType, kingSquare: KingSquareType, setKingSquare: SetKingSquareType, setKingInCheck: SetKingInCheckType, setCheckMate: SetCheckMateType, setStaleMate: SetStaleMateType, setValidMoves: SetValidMovesType, occupiedSquares: OccupiedSquaresType, setOccupiedSquares: SetOccupiedScaresType, fiftyMovesTracker: number, setFiftyMovesTracker: SetFiftyMovesTrackerType) => {
